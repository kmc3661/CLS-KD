...
# from .helper import build_model_with_cfg, named_apply, adapt_input_conv
...
class VisionTransformer(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=3, num_classes=1000, embed_dim=768, depth=12,
                 ...
                 act_layer=None, weight_init='',embed_dim_t=768):
        """
        Args:
        ...
        dim_s = embed_dim
        dim_t = embed_dim_t
        mlp_hidden_dim = int((dim_s + dim_t)//2)
        
        drop = drop_rate
        self.projector = Projector(in_features=dim_s, hidden_features=mlp_hidden_dim,out_features=dim_t, act_layer=act_layer, drop=drop)
...
class VisionTransformer_noproj(nn.Module):
    """ Vision Transformer
